...
class OctoFarmCompanionPlugin(
    ...
    def initialize(self):
        ...
        # with io.open(os.path.join(self.get_plugin_data_folder(), self._excluded_file), "w", encoding="utf-8") as f:
        #     f.write("Hello\n")
    ...
    def get_update_information(self):
        ...
        return dict(
            octofarm_companion=dict(
                ...
                type="github_release",
                user="davidzwa",
                repo="OctoPrint-Octofarm_companion",
                current=self._plugin_version,

                # update method: pip
                pip="https://github.com/davidzwa/OctoPrint-Octofarm_companion/archive/{target_version}.zip"
            )
        )
