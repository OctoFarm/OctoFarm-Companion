...
plugin_version = "0.1.0-rc1-build3"

# The plugin's description. Can be overwritten within OctoPrint's internal data via __plugin_description__ in the plugin
# module
plugin_description = """The companion plugin to bridge the gap between OctoFarm and OctoPrint."""
...
plugin_url = "https://github.com/OctoFarm/OctoFarm-Companion"
